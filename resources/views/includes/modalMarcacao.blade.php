                        ...
                        <div class="col-2">
                            <div class="form-group">
                                ...
                                <select id="tipo_documento" name="tipo_documento" class="custom-select">
                                    ...
                                    <option value="4">Sem Documento</option>
                                </select>         
                            </div>
                        </div>
                        <div id="showNumberDoc" class="col-3">
                            <div class="form-group">
    ...
    function alterar() {
        ...
        var itemSelecionado = dado.options[dado.selectedIndex].value;
            if (itemSelecionado==4) {
                document.getElementById("showNumberDoc").style.display = 'none';
            }else {
                document.getElementById("showNumberDoc").style.display = 'block';
            }
    };
